...
public enum McoreTiers implements IItemTier {
    ...
    /*public static final Tier;STEEL = TierSortingRegistry.registerTier(
            new ForgeTier(3, 1561, 9f, 4f, 14,
                    McoreTags.Blocks.NEEDS_STEEL_TOOL, () -> Ingredient.of(ModItems.STEEL_INGOT.get())),
            new ResourceLocation(MarbledsCore.MODID, "steel"), List.of(Tier.IRON), List.of());

    public static final Tier TITANIUM = TierSortingRegistry.registerTier(
            new ForgeTier(3, 250, 6f, 2f, 14,
                    McoreTags.Blocks.NEEDS_TITANIUM_TOOL, () -> Ingredient.of(ModItems.TITANIUM_INGOT.get())),
