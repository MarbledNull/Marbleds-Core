...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> STEEL_BLOCK = registerBlock("steel_block", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).sound(SoundType.NETHERITE_BLOCK).destroyTime(5.0F).explosionResistance(6.0F).requiresCorrectToolForDrops().color(MaterialColor.METAL)));
    ...
    public static final RegistryObject<Block> TITANIUM_BLOCK = registerBlock("titanium_block", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).sound(SoundType.NETHERITE_BLOCK).destroyTime(5.0F).explosionResistance(6.0F).requiresCorrectToolForDrops().color(MaterialColor.METAL)));
    ...
    public static final RegistryObject<Block> DEEPLSATE_TITANIUM_ORE = registerBlock("deepslate_titanium_ore", () -> new OreBlock(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_IRON_ORE).sound(SoundType.DEEPSLATE).destroyTime(4.5F).explosionResistance(3.0F).requiresCorrectToolForDrops().color(MaterialColor.DEEPSLATE)));
