...
public class ModItems {
    ...
    //tools & weapons
    public static final RegistryObject<Item> STEEL_SWORD = ITEMS.register("steel_sword", () -> new SwordItem(McoreTiers.STEEL, 1, -2.4F, new Item.Properties().durability(2031)));
    public static final RegistryObject<Item> STEEL_PICKAXE = ITEMS.register("steel_pickaxe", () -> new PickaxeItem(McoreTiers.STEEL, -1, -2.8F, new Item.Properties().durability(2031)));
    public static final RegistryObject<Item> STEEL_AXE = ITEMS.register("steel_axe", () -> new AxeItem(McoreTiers.STEEL, 0, 0, new Item.Properties().durability(1561)));
    public static final RegistryObject<Item> STEEL_SHOVEL = ITEMS.register("steel_shovel", () -> new ShovelItem(McoreTiers.STEEL, 0, 0, new Item.Properties().durability(1561)));
    public static final RegistryObject<Item> STEEL_HOE = ITEMS.register("steel_hoe", () -> new HoeItem(McoreTiers.STEEL, 0, 0, new Item.Properties().durability(1561)));

    public static final RegistryObject<Item> TITANIUM_SWORD = ITEMS.register("titanium_sword", () -> new SwordItem(McoreTiers.TITANIUM, 4, -2.4F, new Item.Properties().fireResistant().durability(1561)));
    public static final RegistryObject<Item> TITANIUM_PICKAXE = ITEMS.register("titanium_pickaxe", () -> new PickaxeItem(McoreTiers.TITANIUM, 2, -2.8F, new Item.Properties().fireResistant().durability(1561)));
    public static final RegistryObject<Item> TITANIUM_AXE = ITEMS.register("titanium_axe", () -> new AxeItem(McoreTiers.TITANIUM, 0, 0, new Item.Properties().fireResistant().durability(1561)));
    public static final RegistryObject<Item> TITANIUM_SHOVEL = ITEMS.register("titanium_shovel", () -> new ShovelItem(McoreTiers.TITANIUM, 0, 0, new Item.Properties().fireResistant().durability(1561)));
    public static final RegistryObject<Item> TITANIUM_HOE = ITEMS.register("titanium_hoe", () -> new HoeItem(McoreTiers.TITANIUM, 0, 0, new Item.Properties().fireResistant().durability(1561)));
