...
public class ModItems {
    ...
    public static final RegistryObject<Item> STEEL_CHESTPLATE = ITEMS.register("steel_chestplate", () -> new ArmorItem(McoreArmorMaterials.STEEL, EquipmentSlot.CHEST, new Item.Properties().tab(ModTabs.TABS)));
    public static final RegistryObject<Item> STEEL_LEGGINGS = ITEMS.register("steel_leggings", () -> new ArmorItem(McoreArmorMaterials.STEEL, EquipmentSlot.LEGS, new Item.Properties().tab(ModTabs.TABS)));
    public static final RegistryObject<Item> STEEL_BOOTS = ITEMS.register("steel_boots", () -> new ArmorItem(McoreArmorMaterials.STEEL, EquipmentSlot.FEET, new Item.Properties().tab(ModTabs.TABS)));
    public static final RegistryObject<Item> TITANIUM_HELMET = ITEMS.register("titanium_helmet", () -> new ArmorItem(McoreArmorMaterials.TITANIUM, EquipmentSlot.HEAD, new Item.Properties().fireResistant().tab(ModTabs.TABS)));
    public static final RegistryObject<Item> TITANIUM_CHESTPLATE = ITEMS.register("titanium_chestplate", () -> new ArmorItem(McoreArmorMaterials.TITANIUM, EquipmentSlot.CHEST, new Item.Properties().fireResistant().tab(ModTabs.TABS)));
    public static final RegistryObject<Item> TITANIUM_LEGGINGS = ITEMS.register("titanium_leggings", () -> new ArmorItem(McoreArmorMaterials.TITANIUM, EquipmentSlot.LEGS, new Item.Properties().fireResistant().tab(ModTabs.TABS)));
    public static final RegistryObject<Item> TITANIUM_BOOTS = ITEMS.register("titanium_boots", () -> new ArmorItem(McoreArmorMaterials.TITANIUM, EquipmentSlot.FEET, new Item.Properties().fireResistant().tab(ModTabs.TABS)));
